package ac.clouder.trade_table.DAO;
...
public class CEnTradeDaoImpl extends Dao {

    Logger logger = Logger.getLogger(CEnTradeDaoImpl.class.getName());
...
//        CEnTradeDaoImpl entradeDao = (CEnTradeDaoImpl) applicationContext.getBean("entradeDao");
//        EnTrade enTrade = new EnTrade();
//        enTrade.setA("a");
